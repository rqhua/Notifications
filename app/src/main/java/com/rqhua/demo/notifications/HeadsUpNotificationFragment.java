...
//                        mUseHeadsUpCheckbox.isChecked()));
                if (Build.VERSION.SDK_INT >= 21) {
                    createNotification(mUseHeadsUpCheckbox.isChecked());
     ...
     */
    @RequiresApi(21)
    private void createNotification(boolean makeHeadsUpNotification) {


        Notification.Builder builder = new Notification.Builder(getActivity());
        Intent mIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("http://blog.csdn.net/itachi85/"));
        PendingIntent pendingIntent = PendingIntent.getActivity(getActivity(), 0, mIntent, 0);
...
//        hangIntent.setClass(getActivity(), LNotificationActivity.class);
